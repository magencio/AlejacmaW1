...
class Steps extends Ui.Drawable {
	...
	function draw(dc) {
		...
		dc.drawText(width / 2 - 32, y - fontHeight - 4, font, 196.toChar(), Graphics.TEXT_JUSTIFY_CENTER);		
		dc.drawText(width / 2 + 30, y - fontHeight - 4, font, 196.toChar(), Graphics.TEXT_JUSTIFY_CENTER);		
	}
}